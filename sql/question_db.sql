...
CREATE TABLE `question_types`  (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型标识',
  `display_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '显示名称',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`name` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '题目类型字典表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of question_types
-- ----------------------------
INSERT INTO `question_types` VALUES (1, 'single', '单选题');
INSERT INTO `question_types` VALUES (2, 'multiple', '多选题');
INSERT INTO `question_types` VALUES (3, 'judge', '判断题');
INSERT INTO `question_types` VALUES (4, 'fill', '填空题');
INSERT INTO `question_types` VALUES (5, 'essay', '问答题');
...
CREATE TABLE `questions`  (
  ...
  CONSTRAINT `fk_question_type` FOREIGN KEY (`type_id`) REFERENCES `question_types` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '题目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of questions
-- type_id: 1=single, 2=multiple, 3=judge, 4=fill, 5=essay
-- ----------------------------
INSERT INTO `questions` VALUES (23, 'Java中String类的特点', '以下关于Java中String类的描述，哪个是正确的？', 1, 'medium', '[\"String是可变的\", \"String是不可变的\", \"String可以被继承\", \"String不是线程安全的\"]', '[\"B\"]', NULL, '[\"Java基础\", \"String类\"]', 1, NULL, '2025-09-05 13:59:19', '2025-09-05 13:59:19');
INSERT INTO `questions` VALUES (24, 'Java集合框架的特点', '以下哪些是Java集合框架的特点？（多选）', 2, 'hard', '[\"支持泛型\", \"线程安全\", \"动态扩容\", \"统一接口\"]', '[\"A\", \"C\", \"D\"]', NULL, '[\"Java集合\", \"框架特性\"]', 1, NULL, '2025-09-05 13:59:19', '2025-09-05 13:59:19');
INSERT INTO `questions` VALUES (25, 'Java是面向对象语言', 'Java是一种纯面向对象的编程语言。', 3, 'easy', NULL, NULL, '正确', '[\"Java基础\", \"面向对象\"]', 1, NULL, '2025-09-05 13:59:19', '2025-09-05 14:02:33');
INSERT INTO `questions` VALUES (26, 'Java访问修饰符', 'Java中有四种访问修饰符：______、______、______、______。', 4, 'medium', NULL, NULL, 'public,protected,default,private', '[\"Java基础\", \"访问修饰符\"]', 1, NULL, '2025-09-05 13:59:19', '2025-09-05 14:02:33');
INSERT INTO `questions` VALUES (27, '面向对象三大特性', '请简述面向对象编程的三大特性及其作用。', 5, 'hard', NULL, NULL, '封装、继承、多态。封装隐藏内部实现细节；继承实现代码复用；多态提供统一接口。', '[\"面向对象\", \"编程思想\"]', 1, NULL, '2025-09-05 13:59:19', '2025-09-05 14:02:33');
INSERT INTO `questions` VALUES (28, '测试题目1', '测试题目内容1', 1, 'medium', '[\"答案1\", \"答案2\", \"答案3\", \"答案4\"]', '[\"B\"]', NULL, '[\"Java基础\", \"String类\"]', 1, NULL, '2025-09-06 15:04:51', '2025-09-06 15:04:51');
INSERT INTO `questions` VALUES (29, '1231', '123', 4, 'medium', NULL, NULL, '123', NULL, 1, 1, '2025-09-06 15:34:32', '2025-09-06 15:34:32');
INSERT INTO `questions` VALUES (30, '测试A', '测试A', 1, 'easy', '[\"A\", \"B\"]', '[\"0\"]', NULL, NULL, 1, 1, '2025-10-19 15:18:19', '2025-10-19 15:18:19');
INSERT INTO `questions` VALUES (31, '测试B', '测试B', 1, 'easy', '[\"A\", \"B\"]', '[\"1\"]', NULL, NULL, 1, 1, '2025-10-19 15:18:37', '2025-10-19 15:18:37');
...
CREATE TABLE `wrong_questions`  (
  ...
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `question_id` bigint NOT NULL COMMENT '题目ID',
  `exam_id` bigint NULL DEFAULT NULL COMMENT '来源考试ID',
  `wrong_count` int NULL DEFAULT 1 COMMENT '累计错误次数',
  `mastered` tinyint NULL DEFAULT 0 COMMENT '是否已掌握 0-未掌握 1-已掌握',
  `last_wrong_answer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '最近一次错误答案',
  `created_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_student_question`(`student_id` ASC, `question_id` ASC) USING BTREE,
  INDEX `idx_student_mastered`(`student_id` ASC, `mastered` ASC) USING BTREE,
  INDEX `idx_question_id`(`question_id` ASC) USING BTREE,
  CONSTRAINT `wrong_questions_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `wrong_questions_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `wrong_questions_ibfk_3` FOREIGN KEY (`exam_id`) REFERENCES `exams` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
